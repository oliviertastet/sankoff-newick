...
# La méthode build_sequence_dict construit un dictionnaire avec les séquences présentées dans un fichier fasta nommé seqfile
# La forme du dictionnaire:
# {
#    'seq1_label' : 'AAACGACGCAGCATCAT',
#    ...                               ,
#    'seqn_label' : 'ACATCATCA-ATCATCA'
# }
